...
{
    /// <inheritdoc />
    public partial class RenameAnonymousRequestControlTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnonymousRequestControls", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, true, new DateTime(2025, 11, 4, 7, 58, 12, 0, DateTimeKind.Unspecified), new DateTime(2025, 11, 17, 11, 26, 16, 0, DateTimeKind.Unspecified), "motor" }
                });
        }
