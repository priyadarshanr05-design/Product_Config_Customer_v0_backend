...
{
    public class ParentAPI_ProcessRequest_Service
    {
        private readonly IHttpClientFactory _httpClientFactory;
        private readonly ParentAPI_GenToken_Service _domainService;
        private readonly IUser_Login_DatabaseResolver _dbResolver;
        private readonly ILogger<ParentAPI_ProcessRequest_Service> _logger;
        private readonly IConfiguration _configuration;

        public ParentAPI_ProcessRequest_Service(
            IHttpClientFactory httpClientFactory,
            ParentAPI_GenToken_Service domainService,
            IUser_Login_DatabaseResolver dbResolver,
            IConfiguration configuration,
            ILogger<ParentAPI_ProcessRequest_Service> logger)
        {
