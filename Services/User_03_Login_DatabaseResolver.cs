...
public class User_03_Login_DatabaseResolver : IUser_Login_DatabaseResolver
{
    private readonly DomainManagementDbContext _domainDb;
    private readonly IConfiguration _config;

    public User_03_Login_DatabaseResolver(DomainManagementDbContext domainDb, IConfiguration config)
    {
        _domainDb = domainDb;
        _config = config;
    }
