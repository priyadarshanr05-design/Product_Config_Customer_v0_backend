...
public class Users_01_InternalEmailDomain_Add_Service : IUsers_01_InternalEmailDomain_Add_Service
{
    ...
    public async Task<Users_01_InternalEmailDomain_Add_Response_DTO> AddDomainsAsync(
        Users_01_InternalEmailDomain_Add_DTO dto)
    {
        var response = new Users_01_InternalEmailDomain_Add_Response_DTO
        {
        ...
        {
            var result = new Users_01_InternalEmailDomain_Add_Response_Item_DTO();
