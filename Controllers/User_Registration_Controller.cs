...
namespace Product_Config_Customer_v0.Controllers
{
    ...
    public class User_Registration_Controller : ControllerBase
    {
        private readonly IUser_Login_DatabaseResolver _dbResolver;
        private readonly IEmailSender _email;

        public User_Registration_Controller(IUser_Login_DatabaseResolver dbResolver, IEmailSender email)
        {
